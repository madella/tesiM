...
In particolare nel Publisher~\ref{actor:publisher} prima e dopo la chiamata a funzione di write() %FTODO: inserire nella tesi?
...
Al fine di condurli nel modo più trasparente e corretto possibile sono stati resi pubblici~\cite{mygit} tutti i codici utilizzati durante lo svolgimento di questi test. %TODO5: riordinare & documentare git
...
Inoltre il topic non permette gerarchie ed è difficilmente modificabile a run-time %TODO: glossario
