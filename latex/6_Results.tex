...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{./results/test3_different_protocol_send_receive.png} 
        \caption{differenza tra solo publish e publish-subscribe per ogni protocollo}\label{fig:test3_different_protocols}%TODO Da sistemare immagine, sending Receiving non va bene, label sbagliate etc
\end{figure}
...
\section{Throughput} %TODO da sistemare test3 bandwidth, throughput e Freqeuncy
...
%         \caption{capacità di invio in KByte/s da un publisher a molteplici attori}\label{fig:bandwidth_combined}
% \end{figure}
