...
#ifndef _FAST_DDS_GENERATED_SERVER_PUBSUBTYPES_H_
#define _FAST_DDS_GENERATED_SERVER_PUBSUBTYPES_H_
...
#error \
    Generated server is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
#endif  // GEN_API_VER
...
#endif // _FAST_DDS_GENERATED_SERVER_PUBSUBTYPES_H_