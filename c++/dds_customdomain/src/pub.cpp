...
public:
    ...
    bool init(int domain)
    {
        ...
        topic_ = participant_->create_topic("customDOMAIN", "HelloWorld", TOPIC_QOS_DEFAULT);
        ...
        char** argv)
{
    ...
    int inputInt = std::atoi(argv[1]); 
    std::cout << "Starting pub with domain " << inputInt <<std::endl;
    int samples = 10;

    HelloWorldPublisher* mypub = new HelloWorldPublisher();
    if(mypub->init(inputInt))
    {
